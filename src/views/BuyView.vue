<template>
  <div class="buy container">
    <div v-if="allCart.length">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="from-order__wrapper">
              <div class="from-order__item">
                ...
                <input class="from-order__input" type="text" v-model="userFormData.title" name="name" id="name">
              </div>
              <div class="from-order__item">
                <label for="link" class="from-order__heading">
                  * Ссылка на сайт комании
                </label>
                <input class="from-order__input" type="text" v-model="userFormData.link" name="link" id="link">
              </div>
              <div class="from-order__item">
                <label for="phone" class="from-order__heading">
                  * Номер для связи
                </label>
                <input class="from-order__input" type="tel:" v-model="userFormData.phone" name="phone" id="phone">
              </div>
              <div class="from-order__item">
                <label for="email" class="from-order__heading">
                  * Email
                </label>
                <input class="from-order__input" type="email" v-model="userFormData.email" name="email" id="email">
              </div>
              <div class="from-order__item">
                <label for="price" class="from-order__heading">
                  * Сумма пожертвования
                </label>
                <input class="from-order__input" type="number" v-model="userFormData.price" name="price" id="price" placeholder="Напишите сумму от 10 000р" min="10000" v-bind="item.price">
              </div>
              <div class="from-order__item">
                <p class="from-order__heading">* Требование к логотипу:</p>
                <p class="from-order__text">Размер не менее 120х120, не более 1200х1200.</p>
      ...
      <div class="option">
        <button class="form-order__submit" @click="submitFile()" type="submit">Оплатить заявку</button>
